	...
	var tests = []test{
		...
		},
		{
			chk: Check{
				...
				OpAddr:       common.HexToAddress("5B38Da6a701c568545dCfcB03FcB875f56beddC4"),
				ContractAddr: common.HexToAddress("406AB5033423Dcb6391Ac9eEEad73294FA82Cfbc"),
				CheckSig:     comn.String2Byte("142673fc986aa6d456fba6df9ce82cfdc92cf9af7ea169c41787cf59fcaba9b2721b0b72a121dadd072b1f33743cafb21920e0bea2fe6b435b22ffb715c49d6001"),
			},
			want: false,
		},
	}
	...
	var tests = []test{
		...
		},
		{
			pchk: Paycheck{
				...
				PayValue:    comn.String2BigInt("1000000000000000000"),
				PaycheckSig: comn.String2Byte("56fba6df9ce82cfdc92cf56fba6df9ce82cfdc92cf56fba6df9ce82cfdc92cf56fba6df9ce82cfdc92cf56fba6df9ce82cfdc92cf56fba6df9ce82cfdc92cf56fb"),
			},
			want: false,
		},
	}
